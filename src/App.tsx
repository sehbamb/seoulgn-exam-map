...
export default function SeoulExamCentersMap() {
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      ...
      // 라벨
      map.addLayer({ id: "labels", type: "symbol", source: "centers", filter: ["!has", "point_count"], layout: { "text-field": ["get", "name"], "text-font": ["Noto Sans Regular"], "text-size": 13, "text-offset": [0, 1.2], "text-anchor": "top" }, paint: { "text-halo-color": "#ffffff", "text-halo-width": 0.9 } });
